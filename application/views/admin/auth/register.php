...
<div class="container">
    <div class="row py-5">
        ...
        <div class="col-md-6">
            <div class="card">
            <form action="<?= base_url('registers') ?>" method="POST">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" placeholder="Password" name="password2" required class="form-control">
                    </div>
                    <div align="right">

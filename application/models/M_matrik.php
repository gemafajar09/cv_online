...
class M_matrik Extends CI_Model
{
	...
	public function matrikSaw($id)
	{
		...
		k1/(SELECT MAX(k1) AS k1 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k1,
		k2/(SELECT MAX(k2) AS k2 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k2,
		k3/(SELECT MAX(k3) AS k3 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k3,
		k4/(SELECT MAX(k4) AS k4 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k4,
		k5/(SELECT MAX(k5) AS k5 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k5,
		k6/(SELECT MAX(k6) AS k6 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k6,
		k7/(SELECT MAX(k7) AS k7 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k7,
		k8/(SELECT MAX(k8) AS k8 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k8,
		k9/(SELECT MAX(k9) AS k9 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k9,
		k10/(SELECT MAX(k10) AS k10 FROM tb_matrix WHERE tb_matrix.id_buat = '3') AS k10 
		 FROM tb_matrix WHERE tb_matrix.id_buat = '3') hasil)) 
